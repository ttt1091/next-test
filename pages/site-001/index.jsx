  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles['item-section']}>
        <h2>○○○○</h2>
        <div className={styles['item-section-text']}>
      ...
      <section className={styles['item-section']}>
        ...
        <div className={styles['item-card']}>
          ...
          <div className={styles['item-card-body']}>
            もしもし亀よ<br />
            亀さんよ<br />
            どうしてあんたは<br />
            亀なのよ🐢
      ...
      <section className={styles['item-section']}>
        <h2>○○○○</h2>
        <div className={`${styles['item-section-text']} ${styles['long-text']}`}>
      ...
      <div>
        <a className={styles['link-button']} href="/about">test</a>
        <a className={styles['link-button']} href="/site-001/about">about</a>
      </div>
    </main>
  )
}
